...
namespace GeneticNik {
    class FitnessNik : IFitness {
        public IList<IGeneInfo> GInfo { get; set; }

        public FitnessNik() {
            prep();
            GInfo = new List<IGeneInfo>(5);
        ...
        public ChromosomeDE GetNewChromosome() {
            return new ChromosomeDE(GInfo);
        }

        public double Evaluate(IChromosome chromosome) {
            var c = chromosome as ChromosomeDE;
            if(c == null)
